...
echo                  ^|______________________________________________________________^|
echo=
choice /C:012349 /N /M ">                       请在键盘中输入你的选择 [0、1、2、3、4] : "
...
echo                  ^|     [0] 返回版本选择                                         ^|
echo                  ^|                                                              ^|
echo                  ^|     [1] 安装 Office %batofficever% mini(word excle powerpoint)%verblank%        ^|
echo                  ^|                                                              ^|
echo                  ^|     [2] 安装 Office %batofficever% normal%verblank%                             ^|
echo                  ^|                                                              ^|
echo                  ^|     [3] 安装 Project %batofficever% %verblank%                                  ^|
echo                  ^|                                                              ^|
echo                  ^|     [4] 安装 Visio %batofficever% %verblank%                                    ^|
echo                  ^|                                                              ^|
echo                  ^|     [5] 自定义Office组件                                     ^|
echo                  ^|                                                              ^|
echo                  ^|______________________________________________________________^|
...
echo                  ^|     [0] 返回组件选择                                         ^|
echo                  ^|                                                              ^|
echo                  ^|     [1] 选择 %batofficetype% 更新通道: 当前通道%verblank%%typeblank%          ^|
echo                  ^|                                                              ^|
echo                  ^|     [2] 选择 %batofficetype% 更新通道: 月度企业通道%verblank%%typeblank%      ^|
echo                  ^|                                                              ^|
echo                  ^|     [3] 选择 %batofficetype% 更新通道: 半年度企业通道%verblank%%typeblank%    ^|
echo                  ^|                                                              ^|
echo                  ^|______________________________________________________________^|
echo=
...
echo                  ^|     [0] 返回通道选择                                         ^|
echo                  ^|                                                              ^|
echo                  ^|     [1] 安装 32位 %batofficetype%(%batofficechannel%)%verblank%%typeblank%%channelblank%     ^|
echo                  ^|                                                              ^|
echo                  ^|     [2] 安装 64位 %batofficetype%(%batofficechannel%)%verblank%%typeblank%%channelblank%     ^|
echo                  ^|                                                              ^|
echo                  ^|______________________________________________________________^|
echo=          
...
echo                  ^|     [0] 返回选择通道                                         ^|
echo                  ^|                                                              ^|
echo                  ^|     [1] 安装 32位 %batofficetype%(%batofficechannel%)%typeblank%%verblank%%channelblank%     ^|
echo                  ^|                                                              ^|
echo                  ^|______________________________________________________________^|
echo=
choice /C:012 /N /M ">                       请在键盘中输入你的选择 [0、1、2] : "
