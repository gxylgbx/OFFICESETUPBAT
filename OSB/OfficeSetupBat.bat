...
echo                  ^|                                                             ^|
echo                  ^|      [3] 安装 office2021（word、excle、powerpoint）         ^|
echo                  ^|                                                             ^|
echo                  ^|      [4] 安装 office2021（ALL）                             ^|
echo                  ^|                                                             ^|
echo                  ^|      [5] 安装 office365（word、excle、powerpoint）          ^|
echo                  ^|                                                             ^|
echo                  ^|      [6] 安装 office365（ALL）                              ^|
echo                  ^|                                                             ^|
echo                  ^|_____________________________________________________________^|
echo:          
choice /C:0123456 /N /M ">              请在键盘中输入你的选择 [0、1、2、3、4、5、6] ："
if errorlevel  7 (set officever=office365all) & set verkg=    & goto cn
if errorlevel  6 (set officever=office365mini) & set verkg=   & goto cn
if errorlevel  5 (set officever=office2021all) & set verkg=   & goto cn
if errorlevel  4 (set officever=office2021mini) & set verkg=  & goto cn
...
echo ^<Configuration^>>officetemp.xml
echo   ^<Add OfficeClientEdition="%officeed%" Channel="%officecn%" SourcePath="%officedir%:"^>>>officetemp.xml
echo     ^<Product ID="ProPlus2021Retail"^>>>officetemp.xml
echo       ^<Language ID="zh-cn" /^>>>officetemp.xml
echo       ^<ExcludeApp ID="Access" /^>>>officetemp.xml
echo       ^<ExcludeApp ID="Groove" /^>>>officetemp.xml
echo       ^<ExcludeApp ID="Lync" /^>>>officetemp.xml
...
echo       ^<ExcludeApp ID="Outlook" /^>>>officetemp.xml
echo       ^<ExcludeApp ID="Publisher" /^>>>officetemp.xml
echo       ^<ExcludeApp ID="Teams" /^>>>officetemp.xml
echo     ^</Product^>>>officetemp.xml
echo   ^</Add^>>>officetemp.xml
echo ^</Configuration^>>>officetemp.xml
goto officesetup
